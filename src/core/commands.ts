...
export type Command =
  ...
  | { type: 'FORGE_TAKE' }
  /**
   * Спуститься в шахту ещё раз, не бросая забег. Нужна, чтобы игрок не мог
   * запереть себя в кузнице, выйдя наверх с горстью руды: без этого ни сковать,
   * ни добрать материал было нельзя.
   */
  | { type: 'RETURN_TO_MINE' }
  /**
